...
net_edge2 = assembleNetwork(lgraph);
%%
exportNetworkToTensorFlow(net_edge2,"EdgeError_model2")
exportNetworkToTensorFlow(netLSTM,"EdgeErrorTest_model")
%%
exportONNXNetwork(net_edge2,"edge_error_net2.onnx")
%%
filename = "wc2022_correct (110).mp4";
video = readVideo(filename);
video = imresize(video,inputSize);
[YPred,score] = classify(net_edge2,{video});
YPred
score
%%
